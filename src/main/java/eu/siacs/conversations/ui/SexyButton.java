...
/**
 * Created by lababiba on 24/10/16.
 */
...
public class SexyButton extends ImageButton {
    ...
    public SexyButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SexyButton(Context context, AttributeSet attrs, int defStyleAttr) {
